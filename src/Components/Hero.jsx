  ...
  return (
    <div className='text-white'>
        <div className='max-w-[800px] mt-[96px] w-full h-[80vh] mx-auto text-center flex flex-col justify-center'>
          <p className='text-[#00df98] font-bold p-4'>GROW WITH DATA ANALYTICS</p>
          ...
          <button className='bg-[#00df98] w-[200px] rounded-full font-medium my-6 mx-auto py-3 text-black'>Get Started</button>
        </div>    
    </div>
  )
}
